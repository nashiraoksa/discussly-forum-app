 ...
 * skenario test
 *
 * - asyncPopulateUsersThreadsLeaderboards thunk
...
import { asyncPopulateUsersThreadsLeaderboards } from './action';
...
describe('asyncPopulateUsersThreadsLeaderboards thunk', () => {
  beforeEach(() => {
  ...
  it('should dispatch action correctly when data fetching success', async () => {
    ...
    // action
    await asyncPopulateUsersThreadsLeaderboards()(dispatch);
